...
var Wechat = function () {
	...
	(0, _createClass3.default)(Wechat, [{
		...
		key: 'transfer',
		value: function () {
			var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(params, certUrl) {
				var appid, mch_id, obj, data, sign, xml, result, wechatObj;
				return _regenerator2.default.wrap(function _callee6$(_context6) {
					while (1) {
						switch (_context6.prev = _context6.next) {
							case 0:
								appid = this.appid, mch_id = this.mch_id;
								obj = {
									nonce_str: (0, _utility.generateRandomStr)(),
									mch_appid: appid,
									mchid: mch_id
							...
							case 9:
								...
								return _context6.abrupt('return', wechatObj);
